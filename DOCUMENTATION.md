...
Appointifi is a dual‑sided appointment booking platform focused on the core scheduling workflow between customers and service‑based businesses.

### In Scope (Current MVP)

-   Browse/search businesses with optional location filtering and distance sorting
-   View business details and services
-   Availability calculation (opening hours, existing appointments, recurring blocks, holidays, service duration)
-   Booking creation with pessimistic locking to prevent double‑booking
-   Customer self‑service: view upcoming/completed/cancelled appointments and cancel future ones
-   Business operations: manage profile, location (with geocoding), opening hours, services, appointments, holidays, recurring blocks
-   Email notifications for booking created/cancelled (customer and owner)
-   Role‑based access (customer vs owner), responsive UI, dark mode

### Out of Scope (Current Phase)

-   Payments and invoicing
-   SMS notifications
-   Multi‑location businesses per owner
-   Third‑party calendar sync (Google/Outlook)
-   Reviews/ratings, messaging/chat
-   Native mobile apps, internationalization

### Success Criteria

-   No double‑bookings under concurrent requests (transaction + lock)
-   Accurate availability displayed based on business rules
-   Emails dispatched on booking create/cancel events
-   Clear separation of concerns via service layer and namespaced controllers
