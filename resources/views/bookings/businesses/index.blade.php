                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('bookings.index') }}">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                <label for="location" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Near</label>
                                <input type="text" id="location" name="location" value="{{ $location ?? '' }}" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                            </div>
                            <div>
                        ...
                        <button type="submit" class="px-6 py-3 bg-primary-600 hover:bg-primary-700 rounded-lg text-white">Search</button>
                    </form>
                </div>
            </div>
