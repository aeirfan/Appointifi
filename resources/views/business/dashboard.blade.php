            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $business->appointments()->where('status', 'pending')->count() }}</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Awaiting confirmation</p>
                    </div>
