                                    ...
                                    <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                                        ...
                                        <div class="flex flex-row lg:flex-col gap-2 lg:min-w-[160px]">
                                            <form method="POST" action="{{ route('business.appointments.update-status', $appointment) }}" class="flex-1 lg:flex-none">
                                                ...
                                                <button type="submit" class="w-full px-4 py-2.5 bg-blue-600 hover:bg-blue-700 border border-transparent rounded-lg font-semibold text-xs text-white shadow-md transition-colors duration-200 flex items-center justify-center gap-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <form method="POST" action="{{ route('business.appointments.update-status', $appointment) }}" class="flex-1 lg:flex-none">
                                                ...
                                                <button type="submit" class="w-full px-4 py-2.5 bg-green-600 hover:bg-green-700 border border-transparent rounded-lg font-semibold text-xs text-white shadow-md transition-colors duration-200 flex items-center justify-center gap-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                    </svg>
                                                    Complete
