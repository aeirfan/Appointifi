...
<body>
    ...
    <div class="content">
        ...
        {{ $appointment->business->locations->first()->address }}<br>
        {{ $appointment->business->locations->first()->city }}</p>
        @endif
        
        <p>If you need to cancel or reschedule, please visit your bookings page.</p>
