...
<body>
    <div class="header">
        <h1 style="margin: 0;">⚠️ Booking Cancelled</h1>
    </div>
    
    <div class="content">
        <p>Hi {{ $appointment->business->owner->name }},</p>
        
        <p>A booking for <strong>{{ $appointment->business->name }}</strong> has been cancelled by the customer.</p>
        ...
        <p>This time slot is now available for other customers to book.</p>
